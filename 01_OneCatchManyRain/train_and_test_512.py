...
dem_file = "data_zurich/744/dem/744_dem_asc.asc"
...
def train(batch_size, epoch, save_freq = 40, random_seed = 1, last_epoch=0):
    ...
    # test pattern during last training: 
    # test pattern [ 6  3 13  2 14  7] ['tr2-2', 'tr20', 'tr5-3', 'tr10', 'tr10-3', 'tr5-2']
    
    # this part of code was placed after patch generation and now it is moved here
    # therefore the test patterns may not be the same anymore    
...
def test(model_id="/-79"):
    ...
    test_pattern_index = [ 6, 3, 13,  2, 14,  7]
