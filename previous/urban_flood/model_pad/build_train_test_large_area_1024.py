...
def build_and_train():
    ...
    with tf.Session() as sess:
        ...
        for e in range(epoche):
            ...
            if e % 50 == 49:
                saver.save(sess, "data/model/seg_net_model_pad/",e)
...
#build_and_train()
#test_model("data/model/seg_net_model_pad_1024/-299")
test_model_assemble("data/model/seg_net_model_pad_1024/-299")